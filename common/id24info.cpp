...
void A_CheckAmmo(AActor*);
void A_ConsumeAmmo(AActor*);
void A_GunFlash(AActor*);
void A_GunFlashTo(AActor*);
void A_Light1(AActor*);
void A_Light2(AActor*);
void A_Lower(AActor*);
void A_Raise(AActor*);
void A_ReFire(AActor*);
void A_RefireTo(AActor*);
void A_WeaponJump(AActor*);
void A_WeaponProjectile(AActor*);
void A_WeaponReady(AActor*);
void A_WeaponSound(AActor*);
...
constexpr std::array id24states = std::to_array<state_t>({
	...
	// ------------------------ weapons ------------------------
	// incinerator
	{ .statenum = S_ID24_303, .sprite = SPR_FLMG, .frame = 0,        .tics = 1, .action = A_WeaponReady,      .nextstate = S_ID24_303 },
	{ .statenum = S_ID24_304, .sprite = SPR_FLMG, .frame = 0,        .tics = 1, .action = A_Lower,            .nextstate = S_ID24_304 },
	{ .statenum = S_ID24_305, .sprite = SPR_FLMG, .frame = 0,        .tics = 1, .action = A_Raise,            .nextstate = S_ID24_305 },
	{ .statenum = S_ID24_306, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 0, .action = A_WeaponJump,       .nextstate = S_ID24_307, .args = { S_ID24_308, 128, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_307, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 0, .action = A_WeaponSound,      .nextstate = S_ID24_309, .args = { -1879048173 /* weapons/incinerator/fire1 */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_308, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 0, .action = A_WeaponSound,      .nextstate = S_ID24_309, .args = { -1879048172 /* weapons/incinerator/fire2 */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_309, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 0, .action = A_GunFlash,         .nextstate = S_ID24_310 },
	{ .statenum = S_ID24_310, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_311, .args = { 1, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_311, .sprite = SPR_FLMF, .frame = 0_bright, .tics = 1, .action = A_WeaponProjectile, .nextstate = S_ID24_312, .args = { MT_INCINERATOR_FLAME + 1, 0, 0, 0, 0, 0,0, 0} },
	{ .statenum = S_ID24_312, .sprite = SPR_FLMF, .frame = 1_bright, .tics = 1,                               .nextstate = S_ID24_313 },
	{ .statenum = S_ID24_313, .sprite = SPR_FLMG, .frame = 0,        .tics = 1,                               .nextstate = S_ID24_314 },
	{ .statenum = S_ID24_314, .sprite = SPR_FLMG, .frame = 0,        .tics = 0, .action = A_ReFire,           .nextstate = S_ID24_303 },
	{ .statenum = S_ID24_315,                                        .tics = 2, .action = A_Light2,           .nextstate = S_ID24_316 },
	{ .statenum = S_ID24_316,                                        .tics = 1, .action = A_Light1,           .nextstate = S_LIGHTDONE },
	// incinerator flame
	{ .statenum = S_ID24_317,                     .frame =  0_bright, .tics = 2,                           .nextstate = S_ID24_318 },
	{ .statenum = S_ID24_318, .sprite = SPR_IFLM, .frame =  0_bright, .tics = 2,                           .nextstate = S_ID24_319 },
	{ .statenum = S_ID24_319, .sprite = SPR_IFLM, .frame =  1_bright, .tics = 2, .action = A_PlaySound,    .nextstate = S_ID24_320, .misc1 = -1879048174 /* weapons/incinerator/burn */, .misc2 = 0 },
	{ .statenum = S_ID24_320, .sprite = SPR_IFLM, .frame =  2_bright, .tics = 2,                           .nextstate = S_ID24_321 },
	{ .statenum = S_ID24_321, .sprite = SPR_IFLM, .frame =  3_bright, .tics = 2,                           .nextstate = S_ID24_322 },
	{ .statenum = S_ID24_322, .sprite = SPR_IFLM, .frame =  4_bright, .tics = 2,                           .nextstate = S_ID24_323 },
	{ .statenum = S_ID24_323, .sprite = SPR_IFLM, .frame =  5_bright, .tics = 2,                           .nextstate = S_ID24_324 },
	{ .statenum = S_ID24_324, .sprite = SPR_IFLM, .frame =  6_bright, .tics = 2,                           .nextstate = S_ID24_325 },
	{ .statenum = S_ID24_325, .sprite = SPR_IFLM, .frame =  7_bright, .tics = 2 },
	{ .statenum = S_ID24_326, .sprite = SPR_IFLM, .frame =  0_bright, .tics = 0, .action = A_RandomJump,   .nextstate = S_ID24_327, .misc1 = S_ID24_328, .misc2 = 128 },
	{ .statenum = S_ID24_327, .sprite = SPR_IFLM, .frame =  0_bright, .tics = 0, .action = A_PlaySound,    .nextstate = S_ID24_329, .misc1 = -1879048171 /* weapons/incinerator/hot1 */, .misc2 = 0 },
	{ .statenum = S_ID24_328, .sprite = SPR_IFLM, .frame =  0_bright, .tics = 0, .action = A_PlaySound,    .nextstate = S_ID24_329, .misc1 = -1879048170 /* weapons/incinerator/hot2 */, .misc2 = 0 },
	{ .statenum = S_ID24_329, .sprite = SPR_IFLM, .frame =  8_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_330, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_330, .sprite = SPR_IFLM, .frame =  9_bright, .tics = 2,                           .nextstate = S_ID24_321 },
	{ .statenum = S_ID24_331, .sprite = SPR_IFLM, .frame =  8_bright, .tics = 2,                           .nextstate = S_ID24_332 },
	{ .statenum = S_ID24_332, .sprite = SPR_IFLM, .frame =  9_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_333, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_333, .sprite = SPR_IFLM, .frame = 10_bright, .tics = 2,                           .nextstate = S_ID24_334 },
	{ .statenum = S_ID24_334, .sprite = SPR_IFLM, .frame =  9_bright, .tics = 2,                           .nextstate = S_ID24_335 },
	{ .statenum = S_ID24_335, .sprite = SPR_IFLM, .frame = 10_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_336, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_336, .sprite = SPR_IFLM, .frame = 11_bright, .tics = 2,                           .nextstate = S_ID24_337 },
	{ .statenum = S_ID24_337, .sprite = SPR_IFLM, .frame = 10_bright, .tics = 2, .action = A_PlaySound,    .nextstate = S_ID24_338, .misc1 = -1879048169 /* weapons/incinerator/hot3 */, .misc2 = 0 },
	{ .statenum = S_ID24_338, .sprite = SPR_IFLM, .frame = 11_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_339, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_339, .sprite = SPR_IFLM, .frame = 12_bright, .tics = 2,                           .nextstate = S_ID24_340 },
	{ .statenum = S_ID24_340, .sprite = SPR_IFLM, .frame = 11_bright, .tics = 2,                           .nextstate = S_ID24_341 },
	{ .statenum = S_ID24_341, .sprite = SPR_IFLM, .frame = 12_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_342, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_342, .sprite = SPR_IFLM, .frame = 13_bright, .tics = 2,                           .nextstate = S_ID24_343 },
	{ .statenum = S_ID24_343, .sprite = SPR_IFLM, .frame = 12_bright, .tics = 2,                           .nextstate = S_ID24_344 },
	{ .statenum = S_ID24_344, .sprite = SPR_IFLM, .frame = 13_bright, .tics = 2, .action = A_RadiusDamage, .nextstate = S_ID24_345, .args = { 5, 64, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_345, .sprite = SPR_IFLM, .frame = 14_bright, .tics = 2,                           .nextstate = S_ID24_346 },
	{ .statenum = S_ID24_346, .sprite = SPR_IFLM, .frame = 13_bright, .tics = 2,                           .nextstate = S_ID24_347 },
	{ .statenum = S_ID24_347, .sprite = SPR_IFLM, .frame = 14_bright, .tics = 2,                           .nextstate = S_ID24_348 },
	{ .statenum = S_ID24_348, .sprite = SPR_IFLM, .frame = 15_bright, .tics = 2,                           .nextstate = S_ID24_349 },
	{ .statenum = S_ID24_349, .sprite = SPR_IFLM, .frame = 14_bright, .tics = 2,                           .nextstate = S_ID24_350 },
	{ .statenum = S_ID24_350, .sprite = SPR_IFLM, .frame = 15_bright, .tics = 2 },
	// incinerator pickup
	{ .statenum = S_ID24_351, .sprite = SPR_INCN },
	// calamity blade
	{ .statenum = S_ID24_352, .sprite = SPR_HETG, .frame =  0,        .tics =  1, .action = A_WeaponReady,      .nextstate = S_ID24_352 },
	{ .statenum = S_ID24_353, .sprite = SPR_HETG, .frame =  0,        .tics =  1, .action = A_Lower,            .nextstate = S_ID24_353 },
	{ .statenum = S_ID24_354, .sprite = SPR_HETG, .frame =  0,        .tics =  1, .action = A_Raise,            .nextstate = S_ID24_354 },
	{ .statenum = S_ID24_355, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_356 },
	{ .statenum = S_ID24_356, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_GunFlashTo,       .nextstate = S_ID24_357, .args = { S_ID24_430, 1, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_357, .sprite = SPR_HETG, .frame =  0,        .tics = 20, .action = A_WeaponSound,      .nextstate = S_ID24_358, .args = { -1879048177 /* weapons/calamityblade/charge */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_358, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_CheckAmmo,        .nextstate = S_ID24_359, .args = { S_ID24_420, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_359, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_RefireTo,         .nextstate = S_ID24_420, .args = { S_ID24_360, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_360, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_361 },
	{ .statenum = S_ID24_361, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_GunFlashTo,       .nextstate = S_ID24_362, .args = { S_ID24_434, 1, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_362, .sprite = SPR_HETG, .frame =  0,        .tics = 20, .action = A_WeaponSound,      .nextstate = S_ID24_363, .args = { -1879048177 /* weapons/calamityblade/charge */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_363, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_CheckAmmo,        .nextstate = S_ID24_364, .args = { S_ID24_414, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_364, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_RefireTo,         .nextstate = S_ID24_414, .args = { S_ID24_365, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_365, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_366 },
	{ .statenum = S_ID24_366, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_GunFlashTo,       .nextstate = S_ID24_367, .args = { S_ID24_438, 1, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_367, .sprite = SPR_HETG, .frame =  0,        .tics = 20, .action = A_WeaponSound,      .nextstate = S_ID24_368, .args = { -1879048177 /* weapons/calamityblade/charge */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_368, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_CheckAmmo,        .nextstate = S_ID24_369, .args = { S_ID24_405, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_369, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_RefireTo,         .nextstate = S_ID24_405, .args = { S_ID24_370, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_370, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_371 },
	{ .statenum = S_ID24_371, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_GunFlashTo,       .nextstate = S_ID24_372, .args = { S_ID24_442, 1, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_372, .sprite = SPR_HETG, .frame =  0,        .tics = 20, .action = A_WeaponSound,      .nextstate = S_ID24_373, .args = { -1879048177 /* weapons/calamityblade/charge */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_373, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_CheckAmmo,        .nextstate = S_ID24_374, .args = { S_ID24_393, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_374, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_RefireTo,         .nextstate = S_ID24_393, .args = { S_ID24_375, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_375, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ConsumeAmmo,      .nextstate = S_ID24_376 },
	{ .statenum = S_ID24_376, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_GunFlashTo,       .nextstate = S_ID24_377, .args = { S_ID24_446, 1, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_377, .sprite = SPR_HETG, .frame =  0,        .tics = 20, .action = A_WeaponSound,      .nextstate = S_ID24_378, .args = { -1879048177 /* weapons/calamityblade/charge */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_378, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_379, .args = { MT_HEATWAVE_SPAWNER + 1, -35_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_379, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_380, .args = { MT_HEATWAVE_SPAWNER + 1, -30_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_380, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_381, .args = { MT_HEATWAVE_SPAWNER + 1, -25_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_381, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_382, .args = { MT_HEATWAVE_SPAWNER + 1, -20_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_382, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_383, .args = { MT_HEATWAVE_SPAWNER + 1, -15_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_383, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_384, .args = { MT_HEATWAVE_SPAWNER + 1, -10_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_384, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_385, .args = { MT_HEATWAVE_SPAWNER + 1,  -5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_385, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_386, .args = { MT_HEATWAVE_SPAWNER + 1,   0_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_386, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_387, .args = { MT_HEATWAVE_SPAWNER + 1,   5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_387, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_388, .args = { MT_HEATWAVE_SPAWNER + 1,  10_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_388, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_389, .args = { MT_HEATWAVE_SPAWNER + 1,  15_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_389, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_390, .args = { MT_HEATWAVE_SPAWNER + 1,  20_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_390, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_391, .args = { MT_HEATWAVE_SPAWNER + 1,  25_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_391, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_392, .args = { MT_HEATWAVE_SPAWNER + 1,  30_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_392, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_393, .args = { MT_HEATWAVE_SPAWNER + 1,  35_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_393, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_394, .args = { MT_HEATWAVE_SPAWNER + 1, -27.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_394, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_395, .args = { MT_HEATWAVE_SPAWNER + 1, -22.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_395, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_396, .args = { MT_HEATWAVE_SPAWNER + 1, -17.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_396, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_397, .args = { MT_HEATWAVE_SPAWNER + 1, -12.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_397, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_398, .args = { MT_HEATWAVE_SPAWNER + 1,  -7.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_398, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_399, .args = { MT_HEATWAVE_SPAWNER + 1,  -2.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_399, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_400, .args = { MT_HEATWAVE_SPAWNER + 1,   2.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_400, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_401, .args = { MT_HEATWAVE_SPAWNER + 1,   7.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_401, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_402, .args = { MT_HEATWAVE_SPAWNER + 1,  12.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_402, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_403, .args = { MT_HEATWAVE_SPAWNER + 1,  17.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_403, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_404, .args = { MT_HEATWAVE_SPAWNER + 1,  22.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_404, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_405, .args = { MT_HEATWAVE_SPAWNER + 1,  27.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_405, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_406, .args = { MT_HEATWAVE_SPAWNER + 1, -20_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_406, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_407, .args = { MT_HEATWAVE_SPAWNER + 1, -15_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_407, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_408, .args = { MT_HEATWAVE_SPAWNER + 1, -10_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_408, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_409, .args = { MT_HEATWAVE_SPAWNER + 1,  -5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_409, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_410, .args = { MT_HEATWAVE_SPAWNER + 1,   0_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_410, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_411, .args = { MT_HEATWAVE_SPAWNER + 1,   5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_411, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_412, .args = { MT_HEATWAVE_SPAWNER + 1,  10_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_412, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_413, .args = { MT_HEATWAVE_SPAWNER + 1,  15_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_413, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_414, .args = { MT_HEATWAVE_SPAWNER + 1,  20_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_414, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_415, .args = { MT_HEATWAVE_SPAWNER + 1, -12.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_415, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_416, .args = { MT_HEATWAVE_SPAWNER + 1,  -7.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_416, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_417, .args = { MT_HEATWAVE_SPAWNER + 1,  -2.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_417, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_418, .args = { MT_HEATWAVE_SPAWNER + 1,   2.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_418, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_419, .args = { MT_HEATWAVE_SPAWNER + 1,   7.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_419, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_420, .args = { MT_HEATWAVE_SPAWNER + 1,  12.5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_420, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_421, .args = { MT_HEATWAVE_SPAWNER + 1, -5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_421, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_422, .args = { MT_HEATWAVE_SPAWNER + 1,  0_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_422, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponProjectile, .nextstate = S_ID24_423, .args = { MT_HEATWAVE_SPAWNER + 1,  5_fx, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_423, .sprite = SPR_HETF, .frame =  0_bright, .tics =  0, .action = A_WeaponSound,      .nextstate = S_ID24_424, .args = { -1879048176 /* weapons/calamityblade/shoot */, 0, 0, 0, 0, 0, 0, 0 } },
	{ .statenum = S_ID24_424, .sprite = SPR_HETF, .frame =  0_bright, .tics =  3, .action = A_GunFlash,         .nextstate = S_ID24_425 },
	{ .statenum = S_ID24_425, .sprite = SPR_HETF, .frame =  1_bright, .tics =  5,                               .nextstate = S_ID24_426 },
	{ .statenum = S_ID24_426, .sprite = SPR_HETG, .frame =  3,        .tics =  4,                               .nextstate = S_ID24_427 },
	{ .statenum = S_ID24_427, .sprite = SPR_HETG, .frame =  2,        .tics =  4,                               .nextstate = S_ID24_428 },
	{ .statenum = S_ID24_428, .sprite = SPR_HETG, .frame =  1,        .tics =  4,                               .nextstate = S_ID24_429 },
	{ .statenum = S_ID24_429, .sprite = SPR_HETG, .frame =  0,        .tics =  0, .action = A_ReFire,           .nextstate = S_ID24_352 },
	{ .statenum = S_ID24_430, .sprite = SPR_HETC, .frame =  0_bright, .tics =  6,                               .nextstate = S_ID24_431 },
	{ .statenum = S_ID24_431, .sprite = SPR_HETC, .frame =  1_bright, .tics =  5,                               .nextstate = S_ID24_432 },
	{ .statenum = S_ID24_432, .sprite = SPR_HETC, .frame =  2_bright, .tics =  5,                               .nextstate = S_ID24_433 },
	{ .statenum = S_ID24_433, .sprite = SPR_HETC, .frame =  3_bright, .tics =  5,                               .nextstate = S_LIGHTDONE },
	{ .statenum = S_ID24_434, .sprite = SPR_HETC, .frame =  4_bright, .tics =  6,                               .nextstate = S_ID24_435 },
	{ .statenum = S_ID24_435, .sprite = SPR_HETC, .frame =  5_bright, .tics =  5,                               .nextstate = S_ID24_436 },
	{ .statenum = S_ID24_436, .sprite = SPR_HETC, .frame =  6_bright, .tics =  5,                               .nextstate = S_ID24_437 },
	{ .statenum = S_ID24_437, .sprite = SPR_HETC, .frame =  7_bright, .tics =  5,                               .nextstate = S_LIGHTDONE },
	{ .statenum = S_ID24_438, .sprite = SPR_HETC, .frame =  8_bright, .tics =  6,                               .nextstate = S_ID24_439 },
	{ .statenum = S_ID24_439, .sprite = SPR_HETC, .frame =  9_bright, .tics =  5,                               .nextstate = S_ID24_440 },
	{ .statenum = S_ID24_440, .sprite = SPR_HETC, .frame = 10_bright, .tics =  5,                               .nextstate = S_ID24_441 },
	{ .statenum = S_ID24_441, .sprite = SPR_HETC, .frame = 11_bright, .tics =  5,                               .nextstate = S_LIGHTDONE },
	{ .statenum = S_ID24_442, .sprite = SPR_HETC, .frame = 12_bright, .tics =  6,                               .nextstate = S_ID24_443 },
	{ .statenum = S_ID24_443, .sprite = SPR_HETC, .frame = 13_bright, .tics =  5,                               .nextstate = S_ID24_444 },
	{ .statenum = S_ID24_444, .sprite = SPR_HETC, .frame = 14_bright, .tics =  5,                               .nextstate = S_ID24_445 },
	{ .statenum = S_ID24_445, .sprite = SPR_HETC, .frame = 15_bright, .tics =  5,                               .nextstate = S_LIGHTDONE },
	{ .statenum = S_ID24_446, .sprite = SPR_HETC, .frame = 16_bright, .tics =  6,                               .nextstate = S_ID24_447 },
	{ .statenum = S_ID24_447, .sprite = SPR_HETC, .frame = 17_bright, .tics =  5,                               .nextstate = S_ID24_448 },
	{ .statenum = S_ID24_448, .sprite = SPR_HETC, .frame = 18_bright, .tics =  5,                               .nextstate = S_ID24_449 },
	{ .statenum = S_ID24_449, .sprite = SPR_HETC, .frame = 19_bright, .tics =  5,                               .nextstate = S_LIGHTDONE },
	{ .statenum = S_ID24_450,                                         .tics =  3, .action = A_Light1,           .nextstate = S_ID24_451 },
	{ .statenum = S_ID24_451,                                         .tics =  5, .action = A_Light2,           .nextstate = S_LIGHTDONE },
	// heatwave spawner
	{ .statenum = S_ID24_452, .tics = 0, .nextstate = S_ID24_453 },
	{ .statenum = S_ID24_453, .tics = 1, .action = A_SpawnObject, .args = { MT_HEATWAVE_RIPPER, 0, 0, 0, 0, 20_fx, 0, 0 } },
	// heatwave ripper
	{ .statenum = S_ID24_454, .sprite = SPR_HETB, .frame = 0_bright, .tics = 3, .nextstate = S_ID24_455 },
	{ .statenum = S_ID24_455, .sprite = SPR_HETB, .frame = 1_bright, .tics = 3, .nextstate = S_ID24_456 },
	{ .statenum = S_ID24_456, .sprite = SPR_HETB, .frame = 2_bright, .tics = 3, .nextstate = S_ID24_454 },
	{ .statenum = S_ID24_457, .sprite = SPR_HETB, .frame = 3_bright, .tics = 3, .nextstate = S_ID24_458 },
	{ .statenum = S_ID24_458, .sprite = SPR_HETB, .frame = 4_bright, .tics = 3, .nextstate = S_ID24_459 },
	{ .statenum = S_ID24_459, .sprite = SPR_HETB, .frame = 5_bright, .tics = 3, .nextstate = S_ID24_460 },
	{ .statenum = S_ID24_460, .sprite = SPR_HETB, .frame = 6_bright, .tics = 3, .nextstate = S_ID24_461 },
	{ .statenum = S_ID24_461, .sprite = SPR_HETB, .frame = 7_bright, .tics = 3, .nextstate = S_ID24_462 },
	{ .statenum = S_ID24_462, .sprite = SPR_HETB, .frame = 8_bright, .tics = 3 },
	// calamity blade pickup
	{ .statenum = S_ID24_463, .sprite = SPR_CBLD },
	// fuel can
	{ .statenum = S_ID24_464, .sprite = SPR_FCPU },
	// fuel tank
	{ .statenum = S_ID24_465, .sprite = SPR_FTNK },
});
