...
constexpr std::array id24states = std::to_array<state_t>({
	...
	{ .statenum = S_ID24_55,  .sprite = SPR_GHUL, .frame =  5_bright, .tics =  4, .action = A_MonsterProjectile, .nextstate = S_ID24_56, .args = { MT_GHOUL_BALL, 0, 0, 0, -8_fx, 0, 0, 0 } },
	...
	{ .statenum = S_ID24_125, .sprite = SPR_CSPI, .frame =  8,        .tics =  3 },
	{ .statenum = S_ID24_126, .sprite = SPR_CSPI, .frame =  8,        .tics =  3, .action = A_Pain },
	{ .statenum = S_ID24_127, .sprite = SPR_CSPI, .frame =  9,        .tics = 20, .action = A_Scream },
	{ .statenum = S_ID24_128, .sprite = SPR_CSPI, .frame = 10,        .tics =  7, .action = A_Fall },
	{ .statenum = S_ID24_129, .sprite = SPR_CSPI, .frame = 11,        .tics =  7 },
	{ .statenum = S_ID24_130, .sprite = SPR_CSPI, .frame = 12,        .tics =  7 },
	{ .statenum = S_ID24_131, .sprite = SPR_CSPI, .frame = 13,        .tics =  7 },
	{ .statenum = S_ID24_132, .sprite = SPR_CSPI, .frame = 14,        .tics =  7 },
	{ .statenum = S_ID24_133, .sprite = SPR_CSPI, .frame = 15,        .tics = -1, .action = A_BossDeath },
	{ .statenum = S_ID24_134, .sprite = SPR_CSPI, .frame = 15,        .tics =  5 },
	{ .statenum = S_ID24_135, .sprite = SPR_CSPI, .frame = 14,        .tics =  5 },
	{ .statenum = S_ID24_136, .sprite = SPR_CSPI, .frame = 13,        .tics =  5 },
	{ .statenum = S_ID24_137, .sprite = SPR_CSPI, .frame = 12,        .tics =  5 },
	{ .statenum = S_ID24_138, .sprite = SPR_CSPI, .frame = 11,        .tics =  5 },
	{ .statenum = S_ID24_139, .sprite = SPR_CSPI, .frame = 10,        .tics =  5 },
	{ .statenum = S_ID24_140, .sprite = SPR_CSPI, .frame =  9,        .tics =  5 },
	// shocktrooper
	...
	{ .statenum = S_ID24_143, .sprite = SPR_PPOS, .frame =  0, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_144 },
	{ .statenum = S_ID24_144, .sprite = SPR_PPOS, .frame =  0, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_145 },
	{ .statenum = S_ID24_145, .sprite = SPR_PPOS, .frame =  1, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_146 },
	{ .statenum = S_ID24_146, .sprite = SPR_PPOS, .frame =  1, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_147 },
	{ .statenum = S_ID24_147, .sprite = SPR_PPOS, .frame =  2, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_148 },
	{ .statenum = S_ID24_148, .sprite = SPR_PPOS, .frame =  2, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_149 },
	{ .statenum = S_ID24_149, .sprite = SPR_PPOS, .frame =  3, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_150 },
	{ .statenum = S_ID24_150, .sprite = SPR_PPOS, .frame =  3, .tics =  2, .action = A_Chase,             .nextstate = S_ID24_143 },
	{ .statenum = S_ID24_151, .sprite = SPR_PPOS, .frame =  4, .tics = 10, .action = A_FaceTarget,        .nextstate = S_ID24_152 },
	{ .statenum = S_ID24_152, .sprite = SPR_PPOS, .frame =  5, .tics =  2, .action = A_MonsterProjectile, .nextstate = S_ID24_153 },
	{ .statenum = S_ID24_153, .sprite = SPR_PPOS, .frame =  4, .tics =  4,                                .nextstate = S_ID24_154 },
	{ .statenum = S_ID24_154, .sprite = SPR_PPOS, .frame =  5, .tics =  2, .action = A_MonsterProjectile, .nextstate = S_ID24_155 },
	{ .statenum = S_ID24_155, .sprite = SPR_PPOS, .frame =  4, .tics =  4,                                .nextstate = S_ID24_156 },
	{ .statenum = S_ID24_156, .sprite = SPR_PPOS, .frame =  5, .tics =  2, .action = A_MonsterProjectile, .nextstate = S_ID24_157 },
	{ .statenum = S_ID24_157, .sprite = SPR_PPOS, .frame =  4, .tics =  4,                                .nextstate = S_ID24_143 },
	{ .statenum = S_ID24_158, .sprite = SPR_PPOS, .frame =  6, .tics =  5,                                .nextstate = S_ID24_159 },
	{ .statenum = S_ID24_159, .sprite = SPR_PPOS, .frame =  6, .tics =  5, .action = A_Pain },
	{ .statenum = S_ID24_160, .sprite = SPR_PPOS, .frame =  7, .tics =  0, .action = A_FaceTarget },
	{ .statenum = S_ID24_161, .sprite = SPR_PPOS, .frame =  7, .tics =  5, .action = A_SpawnObject },
	{ .statenum = S_ID24_162, .sprite = SPR_PPOS, .frame =  8, .tics =  5, .action = A_Scream },
	{ .statenum = S_ID24_163, .sprite = SPR_PPOS, .frame =  9, .tics =  5, .action = A_Fall },
	{ .statenum = S_ID24_164, .sprite = SPR_PPOS, .frame = 10, .tics =  5 },
	{ .statenum = S_ID24_165, .sprite = SPR_PPOS, .frame = 11, .tics =  5 },
	{ .statenum = S_ID24_166, .sprite = SPR_PPOS, .frame = 12, .tics = -1 },
	{ .statenum = S_ID24_167, .sprite = SPR_PPOS, .frame = 13, .tics =  5 },
	{ .statenum = S_ID24_168, .sprite = SPR_PPOS, .frame = 14, .tics =  5, .action = A_XScream },
	{ .statenum = S_ID24_169, .sprite = SPR_PPOS, .frame = 15, .tics =  5, .action = A_Fall },
	{ .statenum = S_ID24_170, .sprite = SPR_PPOS, .frame = 16, .tics =  0, .action = A_FaceTarget },
	{ .statenum = S_ID24_171, .sprite = SPR_PPOS, .frame = 16, .tics =  5, .action = A_SpawnObject },
	{ .statenum = S_ID24_172, .sprite = SPR_PPOS, .frame = 17, .tics =  5 },
	{ .statenum = S_ID24_173, .sprite = SPR_PPOS, .frame = 18, .tics =  5 },
	{ .statenum = S_ID24_174, .sprite = SPR_PPOS, .frame = 19, .tics =  5 },
	{ .statenum = S_ID24_175, .sprite = SPR_PPOS, .frame = 20, .tics = -1 },
	{ .statenum = S_ID24_176, .sprite = SPR_PPOS, .frame = 12, .tics =  5 },
	{ .statenum = S_ID24_177, .sprite = SPR_PPOS, .frame = 11, .tics =  5 },
	{ .statenum = S_ID24_178, .sprite = SPR_PPOS, .frame = 10, .tics =  5 },
	{ .statenum = S_ID24_179, .sprite = SPR_PPOS, .frame =  9, .tics =  5 },
	{ .statenum = S_ID24_180, .sprite = SPR_PPOS, .frame =  8, .tics =  5 },
	{ .statenum = S_ID24_181, .sprite = SPR_PPOS, .frame =  7, .tics =  5 },
	// shocktrooper head
	{ .statenum = S_ID24_182, .sprite = SPR_PHED },
	{ .statenum = S_ID24_183, .sprite = SPR_PHED },
	{ .statenum = S_ID24_184, .sprite = SPR_PHED },
	{ .statenum = S_ID24_185, .sprite = SPR_PHED },
	{ .statenum = S_ID24_186, .sprite = SPR_PHED },
	{ .statenum = S_ID24_187, .sprite = SPR_PHED },
	{ .statenum = S_ID24_188, .sprite = SPR_PHED },
	{ .statenum = S_ID24_189, .sprite = SPR_PHED },
	{ .statenum = S_ID24_190, .sprite = SPR_PHED },
	{ .statenum = S_ID24_191, .sprite = SPR_PHED },
	// shocktrooper corpse
	{ .statenum = S_ID24_192, .sprite = SPR_PPOS },
	{ .statenum = S_ID24_193, .sprite = SPR_PPOS },
	{ .statenum = S_ID24_194, .sprite = SPR_PPOS },

	{ .statenum = S_ID24_195, .sprite = -1 },
	{ .statenum = S_ID24_196, .sprite = -1 },
	{ .statenum = S_ID24_197, .sprite = -1 },
	{ .statenum = S_ID24_198, .sprite = -1 },
	{ .statenum = S_ID24_199, .sprite = -1 },
	{ .statenum = S_ID24_200, .sprite = -1 },
	{ .statenum = S_ID24_201, .sprite = -1 },
	{ .statenum = S_ID24_202, .sprite = -1 },
	{ .statenum = S_ID24_203, .sprite = -1 },
	{ .statenum = S_ID24_204, .sprite = -1 },
	{ .statenum = S_ID24_205, .sprite = -1 },
	{ .statenum = S_ID24_206, .sprite = -1 },
	{ .statenum = S_ID24_207, .sprite = -1 },
	{ .statenum = S_ID24_208, .sprite = -1 },
	{ .statenum = S_ID24_209, .sprite = -1 },
	{ .statenum = S_ID24_210, .sprite = -1 },
	{ .statenum = S_ID24_211, .sprite = -1 },
	{ .statenum = S_ID24_212, .sprite = -1 },
	{ .statenum = S_ID24_213, .sprite = -1 },
	{ .statenum = S_ID24_214, .sprite = -1 },
	{ .statenum = S_ID24_215, .sprite = -1 },
	{ .statenum = S_ID24_216, .sprite = -1 },
	{ .statenum = S_ID24_217, .sprite = -1 },
	{ .statenum = S_ID24_218, .sprite = -1 },
	{ .statenum = S_ID24_219, .sprite = -1 },
	{ .statenum = S_ID24_220, .sprite = -1 },
	{ .statenum = S_ID24_221, .sprite = -1 },
	{ .statenum = S_ID24_222, .sprite = -1 },
	{ .statenum = S_ID24_223, .sprite = -1 },
	{ .statenum = S_ID24_224, .sprite = -1 },
	{ .statenum = S_ID24_225, .sprite = -1 },
	{ .statenum = S_ID24_226, .sprite = -1 },
	{ .statenum = S_ID24_227, .sprite = -1 },
	{ .statenum = S_ID24_228, .sprite = -1 },
	{ .statenum = S_ID24_229, .sprite = -1 },
	{ .statenum = S_ID24_230, .sprite = -1 },
	{ .statenum = S_ID24_231, .sprite = -1 },
	{ .statenum = S_ID24_232, .sprite = -1 },
	{ .statenum = S_ID24_233, .sprite = -1 },
	{ .statenum = S_ID24_234, .sprite = -1 },
	{ .statenum = S_ID24_235, .sprite = -1 },
	{ .statenum = S_ID24_236, .sprite = -1 },
	{ .statenum = S_ID24_237, .sprite = -1 },
	{ .statenum = S_ID24_238, .sprite = -1 },
	{ .statenum = S_ID24_239, .sprite = -1 },
	{ .statenum = S_ID24_240, .sprite = -1 },
	{ .statenum = S_ID24_241, .sprite = -1 },
	{ .statenum = S_ID24_242, .sprite = -1 },
	{ .statenum = S_ID24_243, .sprite = -1 },
	{ .statenum = S_ID24_244, .sprite = -1 },
	{ .statenum = S_ID24_245, .sprite = -1 },
	{ .statenum = S_ID24_246, .sprite = -1 },
	{ .statenum = S_ID24_247, .sprite = -1 },
	{ .statenum = S_ID24_248, .sprite = -1 },
	{ .statenum = S_ID24_249, .sprite = -1 },
	{ .statenum = S_ID24_250, .sprite = -1 },
	{ .statenum = S_ID24_251, .sprite = -1 },
	{ .statenum = S_ID24_252, .sprite = -1 },
	{ .statenum = S_ID24_253, .sprite = -1 },
	{ .statenum = S_ID24_254, .sprite = -1 },
	{ .statenum = S_ID24_255, .sprite = -1 },
	{ .statenum = S_ID24_256, .sprite = -1 },
	{ .statenum = S_ID24_257, .sprite = -1 },
	{ .statenum = S_ID24_258, .sprite = -1 },
	{ .statenum = S_ID24_259, .sprite = -1 },
	{ .statenum = S_ID24_260, .sprite = -1 },
	{ .statenum = S_ID24_261, .sprite = -1 },
	{ .statenum = S_ID24_262, .sprite = -1 },
	{ .statenum = S_ID24_263, .sprite = -1 },
	{ .statenum = S_ID24_264, .sprite = -1 },
	{ .statenum = S_ID24_265, .sprite = -1 },
	{ .statenum = S_ID24_266, .sprite = -1 },
	{ .statenum = S_ID24_267, .sprite = -1 },
	{ .statenum = S_ID24_268, .sprite = -1 },
	{ .statenum = S_ID24_269, .sprite = -1 },
	{ .statenum = S_ID24_270, .sprite = -1 },
	{ .statenum = S_ID24_271, .sprite = -1 },
	{ .statenum = S_ID24_272, .sprite = -1 },
	{ .statenum = S_ID24_273, .sprite = -1 },
	{ .statenum = S_ID24_274, .sprite = -1 },
	{ .statenum = S_ID24_275, .sprite = -1 },
	{ .statenum = S_ID24_276, .sprite = -1 },
	{ .statenum = S_ID24_277, .sprite = -1 },
	{ .statenum = S_ID24_278, .sprite = -1 },
	{ .statenum = S_ID24_279, .sprite = -1 },
	{ .statenum = S_ID24_280, .sprite = -1 },
	{ .statenum = S_ID24_281, .sprite = -1 },
	{ .statenum = S_ID24_282, .sprite = -1 },
	{ .statenum = S_ID24_283, .sprite = -1 },
	{ .statenum = S_ID24_284, .sprite = -1 },
	{ .statenum = S_ID24_285, .sprite = -1 },
	{ .statenum = S_ID24_286, .sprite = -1 },
	{ .statenum = S_ID24_287, .sprite = -1 },
	{ .statenum = S_ID24_288, .sprite = -1 },
	{ .statenum = S_ID24_289, .sprite = -1 },
	{ .statenum = S_ID24_290, .sprite = -1 },
	{ .statenum = S_ID24_291, .sprite = -1 },
	{ .statenum = S_ID24_292, .sprite = -1 },
	{ .statenum = S_ID24_293, .sprite = -1 },
	{ .statenum = S_ID24_294, .sprite = -1 },
	{ .statenum = S_ID24_295, .sprite = -1 },
	{ .statenum = S_ID24_296, .sprite = -1 },
	{ .statenum = S_ID24_297, .sprite = -1 },
	{ .statenum = S_ID24_298, .sprite = -1 },
	{ .statenum = S_ID24_299, .sprite = -1 },
	{ .statenum = S_ID24_300, .sprite = -1 },
	{ .statenum = S_ID24_301, .sprite = -1 },
	{ .statenum = S_ID24_302, .sprite = -1 },
