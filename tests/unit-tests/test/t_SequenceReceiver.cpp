...
TEST_F(ReliableSequenceReceiver, BasicReceive)
{
    ...
    receiver.RegisterReliablePacket(0, packet.buf);
    ...
    receiver.RegisterReliablePacket(1, packet.buf);
...
TEST_F(ReliableSequenceReceiver, MultiReceive)
{
    ...
    receiver.RegisterReliablePacket(0, packet.buf);
    receiver.RegisterReliablePacket(1, packet.buf);
    receiver.RegisterReliablePacket(2, packet.buf);
    receiver.RegisterReliablePacket(3, packet.buf);
    receiver.RegisterReliablePacket(4, packet.buf);
...
TEST_F(ReliableSequenceReceiver, OutOfSequence)
{
    ...
    receiver.RegisterReliablePacket(2, packet.buf);
    receiver.RegisterReliablePacket(5, packet.buf);
    receiver.RegisterReliablePacket(3, packet.buf);
    ...
    receiver.RegisterReliablePacket(6, packet.buf);
    REQUIRE(receiver.NextPacket(packet.buf) < 0);

    receiver.RegisterReliablePacket(4, packet.buf);
    REQUIRE(receiver.NextPacket(packet.buf) == 4);

    receiver.RegisterReliablePacket(7, packet.buf);
