...
// Widget ID's
wxInt32 ID_CHKLISTONSTART = XRCID("ID_CHKLISTONSTART");
wxInt32 ID_CHKSHOWBLOCKEDSERVERS = XRCID("ID_CHKSHOWBLOCKEDSERVERS");
wxInt32 ID_BTNADD = XRCID("ID_BTNADD");
wxInt32 ID_BTNREPLACE = XRCID("ID_BTNREPLACE");
wxInt32 ID_BTNDELETE = XRCID("ID_BTNDELETE");
wxInt32 ID_BTNCHOOSEDIR = XRCID("ID_BTNCHOOSEDIR");
wxInt32 ID_BTNUP = XRCID("ID_BTNUP");
wxInt32 ID_BTNDOWN = XRCID("ID_BTNDOWN");

wxInt32 ID_BTNGETENV = XRCID("ID_BTNGETENV");

wxInt32 ID_BTNCLOSE = XRCID("ID_BTNCLOSE");
wxInt32 ID_BTNOK = XRCID("ID_BTNOK");

wxInt32 ID_LSTWADDIR = XRCID("ID_LSTWADDIR");

wxInt32 ID_TXTWADDIR = XRCID("ID_TXTWADDIR");
