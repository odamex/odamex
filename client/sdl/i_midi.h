...
typedef enum
{
    ...
    MIDI_CONTROLLER_FOOT_CONTROL    = 0x4,
    MIDI_CONTROLLER_PORTAMENTO      = 0x5,
    MIDI_CONTROLLER_DATA_ENTRY_MSB  = 0x6,
    ...
    MIDI_CONTROLLER_TREMOLO         = 0x5c,
    MIDI_CONTROLLER_CHORUS          = 0x5d,
    MIDI_CONTROLLER_DETUNE          = 0x5e,
    MIDI_CONTROLLER_PHASER          = 0x5f
} midi_controller_t;
