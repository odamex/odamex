...
// TODO: actually translate this into NEON stuff
#include <sse2neon.h>

#ifdef _MSC_VER
#define NEON_ALIGNED(x) _CRT_ALIGN(16) x
#else
#define NEON_ALIGNED(x) x __attribute__((aligned(16)))
#endif
...
VERSION_CONTROL (r_drawt_neon_cpp, "$Id$")
