...
#ifdef __SWITCH__
	#define AM_PANDOWNKEY	KEY_JOY16
	#define AM_PANUPKEY		KEY_JOY14
	#define AM_PANRIGHTKEY	KEY_JOY15
	#define AM_PANLEFTKEY	KEY_JOY13
	#define AM_ZOOMINKEY	KEY_JOY8
	#define AM_ZOOMINKEY2	0x4e	// DIK_ADD
	#define AM_ZOOMOUTKEY	KEY_JOY7
	#define AM_ZOOMOUTKEY2	0x4a	// DIK_SUBTRACT
	#define AM_GOBIGKEY		0x0b	// DIK_0
	#define AM_FOLLOWKEY	KEY_JOY4
	#define AM_GRIDKEY		KEY_JOY3
	#define AM_MARKKEY		KEY_JOY1
	#define AM_CLEARMARKKEY	KEY_JOY2
#else
