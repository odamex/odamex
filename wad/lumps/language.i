...
// Most of the ordering here is important. For any following languages, the order
// does not matter. 

D_DEVSTR = "Useless mode ON.\n";
D_CDROM = "CD-ROM Version: zdoom.cfg from c:\\zdoomdat\n";
...
OB_BEAST = "%o was charred by a beast.";
OB_CLINK = "%o was slashed by a clink.";
...
OB_HERETICIMP = "%o was scarred by an imp.";
OB_HERETICIMPHIT = "%o was hacked by an imp.";
OB_IRONLICH = "%o was devastated by an ironlich.";
OB_IRONLICHHIT = "%o got up-close and personal with an ironlich.";
OB_BONEKNIGHT = "%o was axed by a knight.";
OB_BONEKNIGHTHIT = "%o was slain by a knight.";
OB_MUMMY = "%o was smashed by a mummy.";
OB_MUMMYLEADER = "%o was shrieked to death by a mummy.";
OB_SNAKE = "%o was rattled by a snake.";
...
// Music names for Doom. These are needed in the string table only so that
// they can be replaced by Dehacked.
// Note that these names are not prefixed with 'd_' because that's how
// Dehacked patches expect them.
...
STSTR_NCON = "Modalità No Clipping Attiva";
STSTR_NCOFF = "Modalità No Clipping Disattiva";
...
C4TEXT =
	"L'ORRENDO VISO DEL DEMONE PIù GROSSO\n"
...
OB_SPIDER = "%o è stato soggiogato dal demone ragno.";
