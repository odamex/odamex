...
translationref_t::translationref_t() : m_table(nullptr), m_player_id(-1), m_rgb(nullptr)
{
}

translationref_t::translationref_t(const byte *table) : m_table(table), m_player_id(-1), m_rgb(nullptr)
{
}
