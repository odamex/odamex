...
CVAR (sv_motd,		"Welcome to Odamex", "Message Of The Day",	
...
CVAR_FUNC_DECL (sv_maxclients, "4", "Maximum clients that can connect to a server",
      CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_LATCH | CVAR_NOENABLEDISABLE)
...
CVAR (sv_nextmap, "", "Tracks next map to be played",
      CVAR_NULL | CVAR_NOENABLEDISABLE)	
...
CVAR (sv_teamsinplay, "2", "Teams that are enabled",
...
CVAR (sv_inttimecountdown, "0",  "Display time left for an intermission screen to next map",
      CVAR_SERVERARCHIVE | CVAR_SERVERINFO)
// Buffer clients' ticcmds to smooth their movement when they have jitter
CVAR (sv_queueticcmds, "1", "Buffer the input of clients experiencing latency spikes to smooth their movement",
		CVAR_SERVERARCHIVE | CVAR_SERVERINFO)
