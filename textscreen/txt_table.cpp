...
static void TXT_CalcTableSize(TXT_UNCAST_ARG(table))
{
    ...
    row_heights = (unsigned int*)malloc(sizeof(int) * rows);
    column_widths = (unsigned int*)malloc(sizeof(int) * table->columns);
...
void TXT_AddWidget(TXT_UNCAST_ARG(table), TXT_UNCAST_ARG(widget))
{
    ...
    table->widgets = (txt_widget_t **)realloc(table->widgets,
...
txt_table_t *TXT_NewTable(int columns)
{
    ...
    table = (txt_table_t *)malloc(sizeof(txt_table_t));
